...
var Orphanages_1 = require("../models/Orphanages");
var orphanages_view_1 = require("../views/orphanages_view");
var Yup = require("yup");
exports["default"] = {
    index: function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        orphanagesRepository = typeorm_1.getRepository(Orphanages_1["default"]);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        orphanage = orphanagesRepository.create({
                            name: name,
                            latitude: latitude,
                            longitude: longitude,
                            about: about,
